...
Enabling management beans provided by other libraries (for example {url-log4j2-docs}/jmx.html[Log4j2] or /constant-values.html#org.quartz.impl.StdSchedulerFactory.PROP*SCHED*JMX_EXPORT[Quartz]) is independent.

See the /jmx/JmxAutoConfiguration.java[`JmxAutoConfiguration`] class for more details.
