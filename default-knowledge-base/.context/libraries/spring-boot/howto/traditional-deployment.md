---
title: "How-to: Traditional Deployment"
...
If you use the Spring Boot , marking the embedded servlet container dependency as provided produces an executable war file with the provided dependencies packaged in a `lib-provided` directory.
...
<wls:weblogic-web-app
	...
	xsi:schemaLocation="<http://java.sun.com/xml/ns/javaee>
		<https://java.sun.com/xml/ns/javaee/ejb-jar*3*0.xsd>
