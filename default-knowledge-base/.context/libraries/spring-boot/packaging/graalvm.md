...
> **Tip:** If you just want to get started and experiment with GraalVM you can jump to the  section and return to this section later.
...
On top of those differences, Spring uses a process called Spring Ahead-of-Time processing, which imposes further limitations.
Please make sure to read at least the beginning of the next section to learn about those.

> **Tip:** The /metadata/Compatibility/[Native Image Compatibility Guide] section of the GraalVM reference documentation provides more details about GraalVM limitations.
...
* GraalVM JSON hint files in ``META-INF/native-image///``:
...
```java
// Example: MyConfiguration__BeanDefinitions
```
