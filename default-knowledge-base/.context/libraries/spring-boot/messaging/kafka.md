...
```java
// Example: MyKafkaStreamsConfiguration
```
...
> **Tip:** You can also register an arbitrary number of beans that implement `StreamsBuilderFactoryBeanConfigurer` for more advanced customizations.
...
For more information, please see the Spring for Apache Kafka /testing.html#ekb[reference manual].
