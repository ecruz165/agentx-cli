...
<project
	...
	<property name="spring-boot.version" value="" />
...
> **Tip:** If you do not want to use the `spring-boot-antlib` module, see the  section of "`How-to Guides`".
...
As explained in the  section, third party starters should not start with `spring-boot`, as it is reserved for official Spring Boot artifacts.
...
> **Tip:** For a list of additional community contributed starters, see the /starter/README.adoc[README file] in the `spring-boot-starters` module on GitHub.
